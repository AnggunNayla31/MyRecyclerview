package com.smktelkommlg.www.myrecyclerview2
    ...
    private val data = arrayOf(
        arrayOf(
            ...
            "Salah seorang ulama dan khatib terkemuka di Masjid" +
                    ...
                    "Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu. KH.\n" +
        ...
        arrayOf(
            "Gatot Soebroto",
            "Jenderal TNI (Purn.) Gatot Soebroto (lahir di" +
                    ...
                    "Semarang.",
            "https://upload.wikimedia.org/wikipedia/commons/b/be/Col_Gatot_Subr" +
                    "oto%2C_Kenang-" +
                    "Kenangan_Pada_Panglima_Besar_Letnan_Djenderal_Soedirman%2C_p27.j" +
                    "pg"
        ),
        arrayOf(
            "Ki Hadjar Dewantara",
            "Raden Mas Soewardi Soerjaningrat (EBI: Suwardi" +
                    ...
                    "Ki Hajar Dewantoro; lahir di Pakualaman, 2 Mei 1889 – meninggal" +
            ...
            "https://upload.wikimedia.org/wikipedia/commons/3/3a/Ki_Hadjar_Dewa" +
                    "ntara_Mimbar_Umum_18_October_1949_p2.jpg"
        ),
        arrayOf(
            "Mohammad Hatta",
            "Dr.(HC) Drs. H. Mohammad Hatta (lahir dengan nama" +
                    "Mohammad Athar, dikenal sebagai Bung Hatta; lahir di Fort de" +
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/VP_Hatta\n" +
                    ".jpg/330px-VP_Hatta.jpg"
        ),
        arrayOf(
            "Soedirman",
            "Jenderal Besar Raden Soedirman (EYD: Sudirman;" +
                    "lahir 24 Januari 1916 – meninggal 29 Januari 1950 pada umur 34" +
                    "tahun) adalah seorang perwira tinggi Indonesia pada masa" +
        ...
        arrayOf(
            ...
            "Dr.(H.C.) Ir. H. Soekarno (ER, EYD: Sukarno, nama" +
                    ...
                    "tahun) adalah Presiden pertama Republik Indonesia yang menjabat" +
                    "pada periode 1945–1967. Ia memainkan peranan penting dalam" +
                    ...
                    "adalah yang pertama kali mencetuskan konsep mengenai Pancasila" +
                    "sebagai dasar negara Indonesia dan ia sendiri yang menamainya.",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Presiden" +
                    "_Sukarno.jpg/330px-Presiden_Sukarno.jpg"
        ),
        arrayOf(
            "Soepomo",
            "Prof. Mr. Dr. Soepomo (Ejaan Soewandi: Supomo;" +
                    ...
                    "Soekarno.",
            "https://upload.wikimedia.org/wikipedia/commons/c/c3/Supomo_from_Pr" +
                    "esident_Website.JPG"
        ),
        arrayOf(
            "Tan Malaka",
            "Tan Malaka atau Ibrahim gelar Datuk Sutan Malaka" +
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/TanMalak" +
                    "a_DariPendjara_ed3.jpg/330px-TanMalaka_DariPendjara_ed3.jpg"
        )
    )
